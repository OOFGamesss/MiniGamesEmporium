...
public static class EmporiumNeonTheme
{
    ...
    public const float StartDoorPanelWidth = 372f;
    ...
    public static readonly Vector4 MainTabPurple = new(0.13f, 0.06f, 0.21f, 1f);
    public static readonly Vector4 MainTabPurpleHovered = new(0.2f, 0.11f, 0.3f, 1f);
    public static readonly Vector4 MainTabPurpleActive = new(0.24f, 0.1f, 0.34f, 1f);
    public static readonly Vector4 MainTabPurpleUnfocused = new(0.09f, 0.05f, 0.14f, 1f);
    public static readonly Vector4 MainTabPurpleUnfocusedActive = new(0.18f, 0.09f, 0.26f, 1f);
    ...
    private static int PushColours()
    {
        ...
        n++;
        Push(ImGuiCol.Border, new Vector4(NeonCyan.X * 0.35f, NeonCyan.Y * 0.35f, NeonCyan.Z * 0.35f, 0.45f));
        n++;
        ...
        n++;
        Push(ImGuiCol.TitleBgActive, new Vector4(0.12f, 0.03f, 0.06f, 1f));
        n++;
