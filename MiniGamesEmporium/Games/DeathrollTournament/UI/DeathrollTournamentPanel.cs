...
/// <summary>Placeholder panel for the Deathroll Tournament game, displaying a centred coming-soon message scaled to fill the available panel area.</summary>

namespace MiniGamesEmporium.Games.DeathrollTournament.UI;
public sealed class DeathrollTournamentPanel
{
    ...
    public void Draw()
    {
        ...
        ImGui.SetWindowFontScale(FontScale);
        ImGui.TextColored(EmporiumNeonTheme.DeathrollTournamentPink, ComingSoonMessage);
        ImGui.SetWindowFontScale(1.0f);
    }
}
